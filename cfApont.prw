...
Static Function InfoQtd(cFile)
  ...
  DEFINE MSDIALOG oDlg2 TITLE "Quantidade" FROM 000, 000  TO 100, 325 COLORS 0, 16777215 PIXEL

    @ 002, 002 GROUP oGroup1 TO 031, 159 OF oDlg2 COLOR 0, 16777215 PIXEL
    @ 014, 007 SAY oSay1 PROMPT "Informe a Quantidade:" SIZE 060, 007 OF oDlg2 COLORS 0, 16777215 PIXEL
    @ 012, 064 MSGET oQuant VAR nQuant SIZE 075, 010 OF oDlg2  PICTURE '@<E 999,999.99' COLORS 0, 16777215 PIXEL valid nQuant > 0
    DEFINE SBUTTON oBtnOk FROM 034, 014 TYPE 01 OF oDlg2 ENABLE
    DEFINE SBUTTON oBtnCnl FROM 034, 118 TYPE 02 OF oDlg2 Action (nOpc:= 2, oDlg2:End())ENABLE
  ...
  */
  ...
  DEFINE MSDIALOG oDlg2 TITLE "Quantidade" FROM 000, 000  TO 260, 406 COLORS 0, 16777215 PIXEL
    ...
    @ 012, 032 SAY oNumOP PROMPT   "oNumOP" SIZE 050, 007 OF oDlg2 COLORS 0, 16777215 PIXEL
    @ 022, 007 SAY oSay3 PROMPT    "Linha      :" SIZE 030, 007 OF oDlg2 COLORS 0, 16777215 PIXEL
    @ 022, 032 SAY oLinha PROMPT   "oLinha" SIZE 025, 007 OF oDlg2 COLORS 0, 16777215 PIXEL
    @ 032, 007 SAY oSay5 PROMPT    "Produto  :" SIZE 025, 007 OF oDlg2 COLORS 0, 16777215 PIXEL
    @ 032, 032 SAY oPrdDesc PROMPT allTrim(cDescPrd) SIZE 162, 007 OF oDlg2 COLORS 0, 16777215 PIXEL   
    ...
    @ 052, 032 SAY oQtdPal PROMPT  "Normal ->" SIZE 025, 007 OF oDlg2 COLORS 0, 16777215 PIXEL
    @ 052, 167 SAY oNPallet PROMPT "oNPallet" SIZE 025, 007 OF oDlg2 COLORS 0, 16777215 PIXEL
    @ 062, 032 SAY oPBR PROMPT     "PBR    ->" SIZE 025, 007 OF oDlg2 COLORS 0, 16777215 PIXEL
    @ 062, 167 SAY oNPBR PROMPT    "oNPBR" SIZE 025, 007 OF oDlg2 COLORS 0, 16777215 PIXEL
    ...
    @ 086, 062 MSGET nQuant VAR nQuant SIZE 127, 010 OF oDlg2 PICTURE '@<E 999,999.99' COLORS 0, 16777215 PIXEL valid nQuant > 0
    DEFINE SBUTTON oBtnOK FROM 112, 020 TYPE 01 OF oDlg2 ENABLE

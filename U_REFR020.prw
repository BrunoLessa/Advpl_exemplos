...
/*	Data: 08/08/2018
	...
	Motivo: Melhorias
	Exemplo fonte que permite imprimir e importar dados para o excel
...
Static Function MntCab()
	...
	Local cEndEmp 	:= "Endereco teste - São Gonçalo, Rio de Janeiro "
	Local cTelEmp 	:= "Tels:(21) 9999-9999 "
	Local cFaxEmp 	:= "Fax: (21) 9999-9999 "
